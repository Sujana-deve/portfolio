...
3. Run:
```bash
git clone https://github.com/Sujana-deve/portfolio.git
...
5. Set **Source code**: `/home/yourusername/portfolio/backend`
6. Set **Virtualenv**: `/home/yourusername/portfolio/backend/venv`
...
```
8. Go to **Files** → create `/home/yourusername/portfolio/backend/.env`:
```
