    ...
    <section style={{
      ...
      <div style={{ 
        ...
        <div style={{ position: 'relative', width: '100%', height: '440px' }} className="hero-desk-illustration">
          ...
          <div style={{ position: 'absolute', left: '10px', bottom: '80px', width: '120px', zIndex: 3, transform: 'rotate(-2deg)' }}>
            <div style={{ background: '#4a6741', height: '20px', borderRadius: '3px 3px 0 0', border: '1px solid var(--brown)', paddingLeft: '8px', color: '#fff', fontSize: '0.55rem', fontFamily: 'monospace', display: 'flex', alignItems: 'center' }}>JavaScript</div>
            <div style={{ background: '#b8380a', height: '22px', border: '1px solid var(--brown)', marginTop: '-2px', paddingLeft: '8px', color: '#fff', fontSize: '0.55rem', fontFamily: 'monospace', display: 'flex', alignItems: 'center' }}>Django</div>
            <div style={{ background: '#4a3221', height: '24px', borderRadius: '0 0 3px 3px', border: '1px solid var(--brown)', marginTop: '-2px', paddingLeft: '8px', color: '#f2ead8', fontSize: '0.55rem', fontFamily: 'monospace', display: 'flex', alignItems: 'center', fontWeight: 'bold' }}>Python</div>
          </div>

          <div style={{ position: 'absolute', right: '20px', bottom: '50px', width: '290px', height: '330px', background: '#e4dac2', border: '3px solid var(--brown-mid)', borderRadius: '16px 16px 4px 4px', boxShadow: '0 10px 25px rgba(74,46,26,0.15)', zIndex: 2, padding: '12px', display: 'flex', flexDirection: 'column' }}>
          ...
          <div style={{ position: 'absolute', top: '20px', left: '120px', background: 'var(--paper)', border: '1px solid var(--brown-xfaint)', padding: '12px', width: '115px', transform: 'rotate(-4deg)', zIndex: 4 }}>
